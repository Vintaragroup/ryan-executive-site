...
- `/system` — operational systems overview
...
- Do not normalize or abstract system diagrams into generic visualizations.
- Do not rewrite system descriptions or copy.
...
4. Read the local Figma reference TSX (`The-system-reference.tsx`).
...
Do not begin these until the system page is approved:

- System diagram interaction
- Shared diagram components
- System visualization refinement
- Animation of system relationships
- Motion choreography
- Content rewriting
- Final system photography
- Performance optimization

## Approval Notes

Add dated review notes here as the system page is implemented.

---

## Critical Notes

System diagrams and relationships should remain page-specific during the first translation pass. Do not extract them into generic diagram components until visual approval is complete and the page is frozen.

Preserve the exact composition of system relationships from the reference file.
